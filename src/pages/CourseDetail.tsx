...
import { Icons } from '../components/atoms/Icons'; // <-- IMPORTAMOS TUS ÍCONOS
...
export const CourseDetail: React.FC = () => {
  ...
  return (
    <DashboardLayout>
      <div className="max-w-7xl mx-auto pb-10 relative z-10">
        ...
        <div className="mb-6 flex items-center gap-3">
          <Link to="/cursos" className="text-gray-400 hover:text-white transition-colors flex items-center gap-1.5 text-sm font-medium">
            <div className="w-[18px] h-[18px]"><Icons type="arrowLeft" /></div>
            Volver
          </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="flex flex-wrap items-center gap-4 border-t border-itec-gray pt-4">
                ...
                >
                  {copySuccess ? (
                    ...
                    <>
                      <div className="w-4 h-4"><Icons type="shareNetwork" /></div>
                      Compartir
                    </>
                  )}
                </button>
          ...
          <div className="lg:col-span-1">
            <div className="bg-itec-surface border border-itec-gray rounded-xl flex flex-col h-full max-h-[800px]">
              <div className="p-4 border-b border-itec-gray bg-itec-sidebar rounded-t-xl shrink-0">
                    ...
                    >
                      <div className="shrink-0 mt-0.5">
                        {isActive ? (
                          ...
                          <div className="w-6 h-6 rounded-full bg-itec-gray flex items-center justify-center text-gray-400 text-xs font-bold">
                            {index + 1}
                          </div>
                        )}
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1.5 mt-1.5 text-xs text-gray-500">
                          <div className="w-3.5 h-3.5"><Icons type="clock" /></div>
                          {video.duration}
                        </div>
                      </div>
                    </button>
      ...
      {/* ========================================================= */}
      {isMaterialModalOpen && (
        <div className="fixed inset-0 z-[100] bg-itec-bg/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-itec-bg border border-itec-gray rounded-2xl w-full max-w-lg shadow-2xl p-6 relative animate-in zoom-in-95 duration-200">
            ...
            {relatedResources.length > 0 ? (
              <div className="space-y-3">
                {relatedResources.map(res => (
                  <div key={res.id} className="bg-itec-surface border border-itec-gray rounded-xl p-3 flex items-center justify-between group hover:border-itec-blue transition-colors">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg bg-itec-gray flex items-center justify-center text-gray-400 group-hover:text-itec-blue transition-colors shrink-0">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-[9px] text-gray-400 bg-itec-sidebar border border-itec-gray px-1.5 py-0.5 rounded font-bold uppercase tracking-wider">{res.type}</span>
              ...
              <div className="text-center py-8 bg-itec-sidebar rounded-xl border border-itec-gray">
                <span className="text-3xl block mb-2">📂</span>
                <p className="text-gray-400 text-sm">No encontramos apuntes específicos para este curso.</p>
              </div>
            )}

            <div className="mt-6 pt-4 border-t border-itec-gray text-center">
